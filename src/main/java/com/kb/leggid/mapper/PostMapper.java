...
import static com.kb.leggid.model.VoteType.DOWNVOTE;
...
public abstract class PostMapper {
    ...
    public abstract Post map(PostRequest postRequest, SubLeggid subLeggid, User user);
